...
int main() {
    ...
    while (temp == 'y' || temp == 'Y') {
        ...
        printf("\n4. Show all Invoices.");
        printf("\n5. Search for Invoices via customer name.");
        ...
        switch (choice) {
            ...
            case 1:
                system("cls");
                while (1) { // Loop to handle multiple sub-menu displays
                    int menuType;
                    ...
                    // After displaying the selected menu, ask if they want to see another
                    printf("\nDo you want to see another sub-menu?:\t");
                    scanf("%d", &menuType);
                    ...
                    // If a valid menu number is entered, loop will repeat and display that menu
                 //   system("cls"); // Clear the screen before displaying the new menu
                }
                break;


            case 2: // Book a Table with Condition
                system("cls");
                ...
                case 3: // Place an Order and Generate Invoice
                system("cls");
                printf("\nEnter name of customer: ");
